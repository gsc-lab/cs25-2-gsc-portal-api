...
export const getStudentTimetable = async function (req, res, next) {
    try {
        ...
        const result = await classroomService.getStudentTimetable(params);
...
export const getProfessorTimetable = async function (req, res, next) {
    try {
        ...
        const targetDate = req.query.date;
        const params = [user_id, targetDate];
        const result = await classroomService.getProfessorTimetable(params);
        res.status(200).json(result);
    } catch(err) {
        next(err)
    }
...
export const postRegisterCourse = async (req, res, next) => {
    try {
        ...
        const result = await classroomService.postRegisterCourse(params);
...
export const postRegisterTimetable = async function (req, res, next) {
    try {
        ...
        const result = await classroomService.postRegisterTimetable(params);
        res.status(201).json({ message: "등록 완료", course: result });
    } catch (err) {
        next(err)
    }
...
export const postRegisterHoliday = async function (req, res, next) {
    try {
        ...
        const result = await classroomService.postRegisterHoliday(params);
...
export const postAssignStudents = async function (req, res, next) {
    try {
        ...
        const result = await classroomService.postAssignStudents(params)
...
export const postHukaStudentTimetable = async function (req, res, next) {
    try {
        ...
        const result = await classroomService.postHukaStudentTimetable(params);
...
export const postHukaCustomSchedule = async function (req, res, next) {
    try {
        ...
        const result = await classroomService.postHukaCustomSchedule(params);
