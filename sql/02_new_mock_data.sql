...
-- =========================================================
-- =========================================================
-- 05. Student Enrollment (모든 강의 ID 반영)
-- course_student 구조: (user_id, course_id, class_id)
-- =========================================================
INSERT INTO course_student (user_id, course_id, class_id) VALUES
-- -----------------------------------------------------------
-- 2623001 (2학년, JP_A반)
-- -----------------------------------------------------------
('2623001', 'C109', NULL),       -- 2학년 정규 (C109) 등록
('2623001', 'C110', NULL),       -- 2학년 정규 (C110) 등록
('2623001', 'SP_JP', 'JP_A'),    -- 일본어 특강 (본인 JP_A반 등록)

-- -----------------------------------------------------------
-- 2623002 (2학년, JP_B반)
-- -----------------------------------------------------------
('2623002', 'C109', NULL),       -- 2학년 정규 (C109) 등록
('2623002', 'C110', NULL),       -- 2학년 정규 (C110) 등록
('2623002', 'SP_JP', 'JP_B'),    -- 일본어 특강 (본인 JP_B반 등록)

-- -----------------------------------------------------------
-- 2624001 (1학년, JP_A반)
-- -----------------------------------------------------------
('2624001', 'C102', NULL),       -- 1학년 정규 (C102) 등록
('2624001', 'SP_JP', 'JP_A'),    -- 일본어 특강 (본인 JP_A반 등록)

-- -----------------------------------------------------------
-- 2624002 (1학년, JP_B반)
-- -----------------------------------------------------------
('2624002', 'C102', NULL),       -- 1학년 정규 (C102) 등록
('2624002', 'SP_JP', 'JP_B'),    -- 일본어 특강 (본인 JP_B반 등록)

-- -----------------------------------------------------------
-- 2624011 (1학년, KR_A반) - 한국어 특강 대상
-- -----------------------------------------------------------
('2624011', 'C102', NULL),       -- 1학년 정규 (C102) 등록
('2624011', 'SP_KR', 'KR_A'),    -- 한국어 특강 (본인 KR_A반 등록)

-- -----------------------------------------------------------
-- 2624012 (1학년, KR_B반) - 한국어 특강 대상
-- -----------------------------------------------------------
('2624012', 'C102', NULL),       -- 1학년 정규 (C102) 등록
('2624012', 'SP_KR', 'KR_B')     -- 한국어 특강 (본인 KR_B반 등록)
;
