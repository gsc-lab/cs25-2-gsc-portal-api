...
-- ('C101', '2025-1', '한국어문법(II)', 0), ('C102', '2025-1', '프로그래밍(II)', 0), ('C103', '2025-1', '일본어회화(II)', 0), ('C104', '2025-1', '직업윤리', 0), ('C105', '2025-1', '한국어회화(II)', 0), ('C106', '2025-1', '일본어문법(II)', 0), ('C107', '2025-1', '인공지능기초수학', 0), ('C108', '2025-1', '캡스톤디자인(I)', 0),
-- ('C109', '2025-1', '일본어문법(IV)', 0), ('C110', '2025-1', '딥러닝이론과실습', 0), ('C111', '2025-1', '캡스톤디자인(II)', 0), ('C112', '2025-1', '일본어회화(IV)', 0), ('C113', '2025-1', '데이터구조및알고리즘(II)', 0), ('C114', '2025-1', '한국어문법(IV)', 0), ('C115', '2025-1', '한국어회화(IV)', 0);

-- -- Special Courses
-- INSERT INTO course (course_id, sec_id, title, is_special) VALUES
-- ('C116', '2025-1', '후까 회화 (1학년)', 1), ('C117', '2025-1', '코이케 특강 (2학년)', 1), ('C118', '2025-1', '후까 회화 (2학년)', 1), ('C119', '2025-1', 'N2 문법', 1), ('C120', '2025-1', 'N2 회화', 1), ('C121', '2025-1', 'N2 어휘', 1), ('C122', '2025-1', 'N2 독해', 1), ('C123', '2025-1', 'N1 회화 (다키타)', 1), ('C124', '2025-1', 'N1 특강 (황수지)', 1), ('C125', '2025-1', 'N1 회화 (코이케)', 1), ('C126', '2025-1', '초급 일본어', 1);

-- -- Course Classes
-- INSERT INTO course_class (class_id, course_id, name) VALUES
-- ('C101A', 'C101', 'A'), ('C102A', 'C102', 'A'), ('C103A', 'C103', 'A'), ('C104A', 'C104', 'A'), ('C105A', 'C105', 'A'), ('C106A', 'C106', 'A'), ('C107A', 'C107', 'A'), ('C108A', 'C108', 'A'),
-- ('C109A', 'C109', 'A'), ('C110A', 'C110', 'A'), ('C111A', 'C111', 'A'), ('C112A', 'C112', 'A'), ('C113A', 'C113', 'A'), ('C114A', 'C114', 'A'), ('C115A', 'C115', 'A'),
-- ('C116A', 'C116', 'A'), ('C117A', 'C117', 'A'), ('C118A', 'C118', 'A'), ('C119A', 'C119', 'A'), ('C120A', 'C120', 'A'), ('C121A', 'C121', 'A'), ('C122A', 'C122', 'A'), ('C123A', 'C123', 'A'), ('C124A', 'C124', 'A'), ('C125A', 'C125', 'A'), ('C126A', 'C126', 'A');

-- -- Course Professors
-- INSERT INTO course_professor (user_id, course_id, class_id) VALUES
-- ('8888001', 'C101', 'C101A'), ('9000003', 'C102', 'C102A'), ('9000005', 'C103', 'C103A'), ('9000004', 'C104', 'C104A'), ('9000006', 'C105', 'C105A'), ('9000007', 'C106', 'C106A'), ('9000008', 'C107', 'C107A'), ('9000004', 'C108', 'C108A'),
-- ('8888002', 'C109', 'C109A'), ('9000004', 'C110', 'C110A'), ('9000004', 'C111', 'C111A'), ('9000005', 'C112', 'C112A'), ('9000004', 'C113', 'C113A'), ('9000006', 'C114', 'C114A'), ('8888001', 'C115', 'C115A'),
-- ('9000005', 'C116', 'C116A'), ('8888002', 'C117', 'C117A'), ('9000005', 'C118', 'C118A'), ('9000007', 'C119', 'C119A'), ('9000010', 'C120', 'C120A'), ('9000007', 'C121', 'C121A'), ('9000007', 'C122', 'C122A'), ('9000009', 'C123', 'C123A'), ('9000011', 'C124', 'C124A'), ('8888002', 'C125', 'C125A'), ('8888002', 'C126', 'C126A');

-- -- Course Targets
-- INSERT INTO course_target (target_id, course_id, grade_id, language_id) VALUES
-- ('T101', 'C101', '1', 'JP'), ('T102', 'C102', '1', 'KR'), ('T103', 'C103', '1', 'KR'), ('T104', 'C104', '1', 'KR'), ('T105', 'C105', '1', 'JP'), ('T106', 'C106', '1', 'KR'), ('T107', 'C107', '1', 'KR'), ('T108', 'C108', '1', 'KR'),
-- ('T109', 'C109', '2', 'KR'), ('T110', 'C110', '2', 'KR'), ('T111', 'C111', '2', 'KR'), ('T112', 'C112', '2', 'KR'), ('T113', 'C113', '2', 'KR'), ('T114', 'C114', '2', 'JP'), ('T115', 'C115', '2', 'JP'),
-- ('T116', 'C116', '1', NULL), ('T117', 'C117', '2', NULL), ('T118', 'C118', '2', NULL), ('T119', 'C119', '1', NULL), ('T120', 'C119', '2', NULL), ('T121', 'C120', '1', NULL), ('T122', 'C120', '2', NULL), ('T123', 'C121', '1', NULL), ('T124', 'C121', '2', NULL), ('T125', 'C122', '1', NULL), ('T126', 'C122', '2', NULL), ('T127', 'C123', '2', NULL), ('T128', 'C124', '2', NULL), ('T129', 'C125', '2', NULL), ('T130', 'C126', '1', NULL);
...
-- ('SCH103', 'C102', 'MON', '5', 'CR003', '2025-1'), ('SCH104', 'C102', 'MON', '6', 'CR003', '2025-1'), ('SCH105', 'C102', 'WED', '5', 'CR003', '2025-1'), ('SCH106', 'C102', 'WED', '6', 'CR003', '2025-1'),
-- ('SCH107', 'C103', 'TUE', '1', 'CR003', '2025-1'), ('SCH108', 'C103', 'TUE', '2', 'CR003', '2025-1'), ('SCH109', 'C103', 'FRI', '5', 'CR003', '2025-1'),
-- ('SCH110', 'C104', 'TUE', '3', 'CR003', '2025-1'),
-- ('SCH111', 'C105', 'TUE', '6', 'CR001', '2025-1'), ('SCH112', 'C105', 'TUE', '7', 'CR001', '2025-1'), ('SCH113', 'C105', 'TUE', '8', 'CR001', '2025-1'),
-- ('SCH114', 'C106', 'THU', '3', 'CR003', '2025-1'), ('SCH115', 'C106', 'THU', '4', 'CR003', '2025-1'),
-- ('SCH116', 'C107', 'THU', '7', 'CR003', '2025-1'), ('SCH117', 'C107', 'THU', '8', 'CR003', '2025-1'),
-- ('SCH118', 'C108', 'FRI', '1', 'CR003', '2025-1'), ('SCH119', 'C108', 'FRI', '2', 'CR003', '2025-1'), ('SCH120', 'C108', 'FRI', '3', 'CR003', '2025-1'),
-- ('SCH121', 'C109', 'MON', '1', 'CR002', '2025-1'), ('SCH122', 'C109', 'MON', '2', 'CR002', '2025-1'),
-- ('SCH123', 'C110', 'MON', '5', 'CR002', '2025-1'), ('SCH124', 'C110', 'MON', '6', 'CR002', '2025-1'), ('SCH125', 'C110', 'WED', '5', 'CR002', '2025-1'), ('SCH126', 'C110', 'WED', '6', 'CR002', '2025-1'),
-- ('SCH127', 'C111', 'TUE', '1', 'CR002', '2025-1'), ('SCH128', 'C111', 'TUE', '2', 'CR002', '2025-1'), ('SCH129', 'C111', 'THU', '5', 'CR002', '2025-1'), ('SCH130', 'C111', 'THU', '6', 'CR002', '2025-1'),
-- ('SCH131', 'C112', 'WED', '3', 'CR002', '2025-1'), ('SCH132', 'C112', 'FRI', '1', 'CR002', '2025-1'), ('SCH133', 'C112', 'FRI', '2', 'CR002', '2025-1'),
-- ('SCH134', 'C113', 'THU', '1', 'CR002', '2025-1'), ('SCH135', 'C113', 'THU', '2', 'CR002', '2025-1'), ('SCH136', 'C113', 'FRI', '8', 'CR002', '2025-1'), ('SCH137', 'C113', 'FRI', '9', 'CR002', '2025-1'),
-- ('SCH138', 'C114', 'THU', '8', 'CR001', '2025-1'), ('SCH139', 'C114', 'THU', '9', 'CR001', '2025-1'),
-- ('SCH140', 'C115', 'FRI', '6', 'CR001', '2025-1'), ('SCH141', 'C115', 'FRI', '7', 'CR001', '2025-1'), ('SCH142', 'C115', 'FRI', '8', 'CR001', '2025-1');
