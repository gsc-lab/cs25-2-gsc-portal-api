...
INSERT INTO course_class (class_id, course_id, name) VALUES
                                                         ('C116A', 'C116', '후까 회화 (1학년)A'),
                                                         ('C116B', 'C116', '후까 회화 (1학년)B'),

                                                         ('C117A', 'C117', '코이케 특강 (2학년)A'),
                                                         ('C117B', 'C117', '코이케 특강 (2학년)B'),

                                                         ('C118A', 'C118', '후까 회화 (2학년)A'),
                                                         ('C118B', 'C118', '후까 회화 (2학년)B'),
                                                         ...
                                                         ('C123A', 'C123', 'N1 회화 (다키타)A'),
                                                         ('C123B', 'C123', 'N1 회화 (다키타)B'),

                                                         ('C124A', 'C124', 'N1 특강 (황수지)A'),
                                                         ('C124B', 'C124', 'N1 특강 (황수지)B'),

                                                         ('C125A', 'C125', 'N1 회화 (코이케)A'),
                                                         ('C125B', 'C125', 'N1 회화 (코이케)B'),
